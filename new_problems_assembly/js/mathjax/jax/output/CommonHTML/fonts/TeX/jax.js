...
(function (o, f, m, a) {
    ...
    a.Augment({
        ...
        Startup: function () {
            ...
            var s = a.addElement(document.body, "mjx-block", {style: {display: "block", width: "5in"}});
            this.pxPerInch = s.offsetWidth / 5;
            s.parentNode.removeChild(s);
            this.TestSpan = a.Element("mjx-test", {style: {left: "1em"}}, [["mjx-left-box"], ["mjx-ex-box"], ["mjx-right-box"]]);
        ...
        getDefaultExEm: function () {
            ...
            this.defaultWidth = Math.max(0, s.lastChild.offsetLeft - s.firstChild.offsetLeft - 2);
        ...
        preTranslate: function (w) {
            var v = w.jax[this.id], E, B = v.length, H, z, C, F, t, G, s, I;
            var y = 100000, x = false, D = 0, u = c.automatic, A = c.width;
            if (u) {
            ...
            for (E = 0; E < B; E++) {
                ...
                t.CHTML = {display: (t.root.Get("display") === "block"), preview: (t.CHTML || {}).preview};
                ...
                if (t.CHTML.display) {
                    var J = a.Element("mjx-chtml", {className: "MJXc-display", isMathJax: false});
                    J.appendChild(C);
                    C = J
                }
            ...
            for (E = 0; E < B; E++) {
                ...
                D = Math.max(0, t.CHTML.display ? F.lastChild.offsetWidth - 1 : F.lastChild.offsetLeft - F.firstChild.offsetLeft - 2);
                if (G === 0 || G === "NaN") {
                    G = this.defaultEx;
                    D = this.defaultWidth
                }
                ...
                I = Math.floor(Math.max(this.config.minScaleAdjust / 100, I) * this.config.scale);
                t.CHTML.scale = I / 100;
                t.CHTML.fontSize = I + "%";
                t.CHTML.outerEm = s;
        ...
        Translate: function (t, x) {
            ...
            var s = t.MathJax.elementJax, w = s.root, v = document.getElementById(s.inputID + "-Frame");
            if (!v) {
                return
            }
            this.getMetrics(s);
        ...
        getHoverBBox: function (s, v, w) {
            var x = s.root.CHTML, u = s.CHTML.outerEm;
        ...
        Zoom: function (u, B, A, s, y) {
            ...
            t.position = "absolute";
            var z = v.offsetWidth, x = v.offsetHeight, D = A.firstChild.offsetHeight, w = A.firstChild.offsetWidth;
            v.style.position = "";
        ...
        SPACECLASS: {thinmathspace: "MJXc-space1", mediummathspace: "MJXc-space2", thickmathspace: "MJXc-space3"},
        pxPerInch: 96,
        em: 16,
        ...
        getCharList: function (w, v) {
            ...
            var t = this.FONTDATA.RANGES, A = this.FONTDATA.VARIANT;
        ...
        getUnknownChar: function (t, v) {
            ...
            t[v] = [0.8, 0.2, s.w, 0, s.w, {a: Math.max(0, (s.h - s.d) / 2), h: s.h, d: s.d}];
            t[v].c = u
        },
        styledText: function (t, w) {
            ...
            if (!v["_" + w]) {
                ...
                v["_" + w] = [0.8, 0.2, s.w, 0, s.w, {a: Math.max(0, (s.h - s.d) / 2), h: s.h, d: s.d}];
                v["_" + w].c = w
            }
            return {type: "unknown", n: "_" + w, font: v, style: u, rscale: t.rscale}
        },
        getHDW: function (B, u, F) {
            var t = a.addElement(a.CHTMLnode, "mjx-chartest", {className: u}, [["mjx-char", {style: F}, [B]]]);
            var s = a.addElement(a.CHTMLnode, "mjx-chartest", {className: u}, [["mjx-char", {style: F}, [B, ["mjx-box"]]]]);
            t.firstChild.style.fontSize = s.firstChild.style.fontSize = "";
            var v = 5 * a.em;
            var E = t.offsetHeight, C = s.offsetHeight, x = t.offsetWidth;
        ...
        charList: {
            "char": function (D, x, B, u, y) {
                var w = D.font, A = (w.remapCombining || {})[D.n];
                ...
                t = a.addElement(t, "mjx-charbox", {className: u.className, style: s}, [u.text]);
                if (u.a) {
        ...
        handleText: function (u, x, t, w) {
            ...
            var s = {text: x, i: 0, length: x.length}, v = [];
            if (t.style && s.length) {
        ...
        createChar: function (u, y, w, t) {
            var B = "", x = {fonts: [y[1]], noRemap: true, cache: {}};
            ...
            var A = this.handleText(u, B, x), s = u.firstChild.style;
            if (w !== 1) {
    ...
    a.BBOX = MathJax.Object.Subclass({
        ...
        zero: function () {
            return a.BBOX({h: 0, d: 0, w: 0, l: 0, r: 0, t: 0, b: 0, scale: 1, rscale: 1})
        },
        empty: function (s) {
            if (!s) {
                s = a.BBOX.zero()
    ...
    MathJax.Hub.Register.StartupHook("mml Jax Ready", function () {
        ...
        d.mbase.Augment({
            toCommonHTML: function (t, s) {
                ...
                return this.CHTMLhandleAttributes(a.addElement(s, "mjx-" + this.type, {id: t}))
                ...
                if (this.attrNames) {
                    var z = this.attrNames, u = d.nocopyAttributes, y = f.config.ignoreMMLattributes;
                ...
                var x = 1, u = this.parent, w = (u ? u.CHTML.scale : 1);
            ...
            }, CHTMLautoloadList: {}, CHTMLautoloadFile: function (s) {
        ...
        d.mi.Augment({
            toCommonHTML: function (s) {
                ...
                var u = this.CHTML, t = this.data.join("");
        ...
        d.mn.Augment({
            CHTMLremapMinus: function (s) {
                ...
                s = this.CHTMLdefaultNode(s, {childOptions: {remap: this.CHTMLremapMinus}});
                var u = this.CHTML, t = this.data.join("");
                if (u.skew != null && !a.isChar(t)) {
                    delete u.skew
                }
        ...
        d.mo.Augment({
            toCommonHTML: function (v) {
                ...
                if (a.isChar(u.text) && t && t.isa(d.munderover)) {
                    var v = t.data[t.over], s = t.data[t.under];
                ...
                var s = t.parent, u = (s && s.isa(d.msubsup) && this !== s.data[s.base]);
                if (t.largeop) {
                ...
                s = s.firstChild;
                var t = a.Element("mjx-box", {style: {width: ".25em", "margin-left": "-.25em"}});
                ...
                var w = this.CHTMLnodeElement(), x = this.CHTML;
        ...
        d.mspace.Augment({
            toCommonHTML: function (v) {
                ...
                var s = this.CHTMLlength2em(t.width), u = this.CHTMLlength2em(t.height),
        ...
        d.mpadded.Augment({
            toCommonHTML: function (t, F) {
                ...
                if (F && F.stretch) {
                    ...
                    t = this.CHTMLdefaultNode(t, {childNodes: "mjx-box", forceChild: true});
                    s = t.firstChild;
        ...
        d.munderover.Augment({
            toCommonHTML: function (w, G) {
                ...
                if (G && G.stretch) {
                    ...
                    w = this.CHTMLdefaultNode(w, {childNodes: y, noBBox: true, forceChild: true, minChildren: 2});
                ...
                var x = [], v = this.CHTMLgetBBoxes(x, s, E);
                var F = x[this.base], C = this.CHTML;
                C.w = v;
                C.h = F.h;
                C.d = F.d;
                if (F.h < 0.35) {
            ...
            CHTMLaddOverscript: function (B, z, F, E, t, s) {
                ...
                var A = z[this.over], G = z[this.base], u = A.rscale;
                if (!s) {
        ...
        d.msubsup.Augment({
            toCommonHTML: function (S, C) {
                ...
                if (C && C.stretch) {
                    ...
                    S = this.CHTMLdefaultNode(S, {childNodes: K, noBBox: true, forceChild: true, minChildren: 3});
                ...
                var F = [], G = a.BBOX.empty(this.CHTML);
                for (var V = 0, T = this.data.length; V < T; V++) {
                    F[V] = this.CHTMLbboxFor(V)
                }
                var y = F[this.base] || a.BBOX.empty(), P = F[this.sub], W = F[this.sup];
                var B = (H ? P.rscale : 1), w = (z ? W.rscale : 1);
                G.combine(y, 0, 0);
                var X = a.TEX.x_height, N = a.TEX.scriptspace;
                var Q = a.TEX.sup_drop * w, O = a.TEX.sub_drop * B;
                ...
                if (U) {
                    ...
                    if (U.type === "mi" || U.type === "mo") {
                        if (a.isChar(U.data.join("")) && y.rscale === 1 && !y.sH && !U.Get("largeop")) {
                            L = J = 0
                        }
                    }
                }
        ...
        d.mfrac.Augment({
            toCommonHTML: function (N) {
                ...
                var D = N.firstChild, w = N.lastChild;
                ...
                var P = this.CHTMLbboxFor(0), B = this.CHTMLbboxFor(1), C = a.BBOX.empty(this.CHTML), F = P.rscale,
                    z = B.rscale;
                x.linethickness = Math.max(0, a.thickness2em(x.linethickness || "0", C.scale));
                var M = a.TEX.min_rule_thickness / a.em, T = a.TEX.axis_height;
                ...
                if (x.bevelled) {
                    ...
                    a.addElement(N, "mjx-vsize", {style: {height: a.Em(C.h + C.d), verticalAlign: a.Em(-C.d)}})
                }
        ...
        d.msqrt.Augment({
            toCommonHTML: function (w) {
                w = this.CHTMLdefaultNode(w, {childNodes: ["mjx-box", "mjx-root"], forceChild: true, noBBox: true});
                var v = w.firstChild || a.Element("mjx-box");
                var E = a.addElement(w, "mjx-box");
                E.appendChild(v);
                var F = this.CHTMLbboxFor(0), C = a.BBOX.empty(this.CHTML);
        ...
        d.mroot.Augment({
            ...
            CHTMLaddRoot: function (A, u, v) {
                ...
                var z = this.CHTML, B = this.data[1].CHTML, x = A.firstChild;
                var s = B.rscale;
        ...
        d.mfenced.Augment({
            toCommonHTML: function (v) {
                ...
                var t = this.CHTML.h, w = this.CHTML.d;
        ...
        d.TeXAtom.Augment({
            toCommonHTML: function (x, w) {
                ...
                if (this.texClass === d.TEXCLASS.VCENTER) {
                    var s = a.TEX.axis_height, u = this.CHTML;
