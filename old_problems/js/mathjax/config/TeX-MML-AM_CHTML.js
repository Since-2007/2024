...
(function (a, d, f, c, j) {
    ...
    var h = MathJax.Extension.MathZoom = {
        version: k, settings: a.config.menuSettings, scrollSize: 18, HandleEvent: function (n, l, m) {
...
(function (f, o, q, e, r) {
    ...
    var g = MathJax.Menu = h.Subclass({
        version: p, items: [], posted: false, title: null, margin: 5, Init: function (u) {
    ...
    g.ITEM.RADIO = g.ENTRY.Subclass({
        variable: null, marker: (a ? "\u25CF" : "\u2713"), role: "menuitemradio", Attributes: function (v) {
...
(function (d, c, j) {
    ...
    var a = MathJax.Object.Subclass({
        ...
        MakeBig: function (m, p, n) {
            ...
            this.Push(i.mstyle(i.TeXAtom(i.mo(o).With({
                ...
                stretchy: true,
                symmetric: true
            })).With({texClass: p})).With({scriptlevel: 0}))
        },
        BuildRel: function (m) {
    ...
    d.Augment({
        ...
        fenced: function (o, n, p) {
            ...
            m.Append(i.mo(o).With({fence: true, stretchy: true, symmetric: true, texClass: i.TEXCLASS.OPEN}));
            if (n.type === "mrow" && n.inferred) {
                m.Append.apply(m, n.data)
            } else {
                m.Append(n)
            }
            m.Append(i.mo(p).With({fence: true, stretchy: true, symmetric: true, texClass: i.TEXCLASS.CLOSE}));
            return m
        },
...
(function (aa) {
    ...
    var Q = {};
    var e = {
        getElementById: true, createElementNS: function (ac, ab) {
            var ad = g[ab]();
    ...
    var z = [{input: "alpha", tag: "mi", output: "\u03B1", tex: null, ttype: c}, {
        ...
        tag: "mstyle",
        ttype: U
    }, {input: "id", tag: "mrow", ttype: U}, {input: "class", tag: "mrow", ttype: U}, {
        input: "cancel",
        tag: "menclose",
        output: "cancel",
        tex: null,
    ...
    function G(ai) {
        var ad, ac, al, af, ak, ag = e.createDocumentFragment();
        ai = p(ai, 0);
        ad = j(ai);
            ...
            if (at > 0 && ah.childNodes[at - 1].nodeName == "mrow" && ah.childNodes[at - 1].lastChild && ah.childNodes[at - 1].lastChild.firstChild) {
                ...
                if (av == ")" || av == "]") {
                    ...
                    if (ac == "(" && av == ")" && ao.output != "}" || ac == "[" && av == "]") {
                        ...
                        var af = [];
                        if (ap) {
                            var ae, ab, ai, an, au = e.createDocumentFragment();
...
!function (a, b) {
    ...
    var i = b["accessibility-menu"] = {
        version: "1.5.0", prefix: "", defaults: {}, modules: [], MakeOption: function (a) {
            return i.prefix + a
